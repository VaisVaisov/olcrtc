...
const (
	...
	defaultJitsiRoomURL = "https://meet.systemli.org"
)
...
// (e.g. seichannel against meet.systemli.org's bandwidth allocator)
...
func realRoomURL(ctx context.Context, t *testing.T, carrierName string) string {
	...
	case "jitsi":
		...
		// on first join. The default flag points at meet.systemli.org.
