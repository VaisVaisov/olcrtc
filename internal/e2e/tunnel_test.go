...
const (
	...
	defaultJitsiRoomURL = "https://fairmeeting.net"
)
...
// (e.g. seichannel against fairmeeting.net's bandwidth allocator)
...
func realRoomURL(ctx context.Context, t *testing.T, carrierName string) string {
	...
	case "jitsi":
		...
		// on first join. The default flag points at fairmeeting.net.
